                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div>
                                ...
                                <br>
                                <b>Total Items: </b> <?php echo e($reporteItems->count()); ?><br>
                                <b>Total General de Items: </b> <span style="color: green; font-size: 1.2em;"><?php echo e(number_format($total_general, 2)); ?></span>
                            </div>
                                    ...
                                    <?php $__currentLoopData = $reporteItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <span class="badge badge-info"><?php echo e($duracion); ?></span>
                                            </td>
                                            <td>
