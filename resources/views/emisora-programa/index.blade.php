										...
										<td >{{ $emisoraPrograma->costo }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('emisora.programas.destroy', $emisoraPrograma->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('emisora.programas.show', $emisoraPrograma->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Ver') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('emisora.programas.edit', $emisoraPrograma->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Editar') }}</a>
                                                    @csrf
                                                    @method('DELETE')
