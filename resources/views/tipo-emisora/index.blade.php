										...
										<td >{{ $tipoEmisora->name }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('tipo-emisoras.destroy', $tipoEmisora->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('tipo-emisoras.show', $tipoEmisora->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('tipo-emisoras.edit', $tipoEmisora->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
