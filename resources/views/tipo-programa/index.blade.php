										...
										<td >{{ $tipoPrograma->name }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('tipo-programas.destroy', $tipoPrograma->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('tipo-programas.show', $tipoPrograma->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('tipo-programas.edit', $tipoPrograma->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
